...
class imdb {
 ...
 private:
  ...
  string getActorName(void * playerAddr) const;
  void getMovieOffsets(void * playerAddr, vector<film> &films, string playerName) const;
  void getMovies(vector<film> &films, int movieOffset[], int numOfMovies) const;
  film getMovie(void * movieRecord) const;
  void getMovieCast(void * movieRecord, film movie, vector<string> &players) const;
  void getActors(vector<string> &players, int actorOffsets[], int numOfActors) const;
