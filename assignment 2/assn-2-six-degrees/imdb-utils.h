...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  if (strcasecmp(ostype, "linux") == 0)
    return "/Users/pratyushaj/Documents/Programming Paradigms/assignments/assn-2-six-degrees-data/little-endian/";
  if (strcasecmp(ostype, "solaris") == 0)
    return "/Users/pratyushaj/Documents/Programming Paradigms/assignments/assn-2-six-degrees-data/big-endian/";
